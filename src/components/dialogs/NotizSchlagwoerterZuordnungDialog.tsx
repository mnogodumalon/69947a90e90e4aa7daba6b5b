...
export function NotizSchlagwoerterZuordnungDialog({ open, onClose, onSubmit, defaultValues, notizenList, schlagwoerterList, enablePhotoScan: _enablePhotoScan = false, enablePhotoLocation: _enablePhotoLocation = true }: NotizSchlagwoerterZuordnungDialogProps) {
