...
export function NotizSchlagwoerterZuordnungDialog({ open, onClose, onSubmit, defaultValues, notizenList, schlagwoerterList }: NotizSchlagwoerterZuordnungDialogProps) {
