...
import { FileText, LayoutDashboard, MapPin, Menu, Settings, Tag, Undo2 } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'Notizenverwaltung';
...
const navigation = [
  ...
  { name: 'Notiz-Schlagwörter-Zuordnung', href: '/notiz-schlagwoerter-zuordnung', icon: MapPin },
  { name: 'Notizen', href: '/notizen', icon: FileText },
  { name: 'Schlagwörter', href: '/schlagwoerter', icon: MapPin },
  { name: 'Schnellerfassung', href: '/schnellerfassung', icon: FileText },
];

const externalNavigation = [
  { name: 'Kategorien', href: '/gateway/apps/69947a6c9b00d7ae1a66583d?template=list_page', icon: Tag },
  { name: 'Notiz-Schlagwörter-Zuordnung', href: '/gateway/apps/69947a73400e119a41d3e876?template=list_page', icon: MapPin },
  { name: 'Notizen', href: '/gateway/apps/69947a7338cc60e9b64f6817?template=list_page', icon: FileText },
  { name: 'Schlagwörter', href: '/gateway/apps/69947a72b56677beb9f4f1d5?template=list_page', icon: MapPin },
  { name: 'Schnellerfassung', href: '/gateway/apps/69947a74f207e8a598d92878?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69947a6c9b00d7ae1a66583d?template=list_page"
