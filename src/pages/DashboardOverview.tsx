...
import { AlertCircle, Bell, BookOpen, CheckCircle2, Circle, Clock, FolderOpen, Layers, Pencil, Plus, Search, StickyNote, Tag, Trash2, X } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <StatCard
          ...
          icon={<StickyNote size={18} className="text-muted-foreground" />}
        />
        <StatCard
          title="Erledigt"
        ...
        <StatCard
          ...
          icon={<Layers size={18} className="text-muted-foreground" />}
        />
        <StatCard
